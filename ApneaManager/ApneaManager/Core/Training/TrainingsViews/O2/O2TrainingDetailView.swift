...
struct O2TrainingDetailView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            VStack(alignment: .leading) {
                List {
                    Section {
                            ...
                            Text("This preparation right before beginning ensures you're mentally and physically ready to start your O2 table session effectively and safely.")
                    ...
                    Section {
                        ...
                        Text("Ensure your timer is set with the pre-planned O2 table intervals."
                        )
                    } header: {
            ...
            .navigationTitle("O2 Table Guidance")
        }
    }
}
